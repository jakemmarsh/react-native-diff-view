...
export const normalChange: IChange = { isNormal: true, lineNumber: 0, oldLineNumber: 0, type: 'normal' };
export const insertChange: IChange = { isInsert: true, lineNumber: 0, oldLineNumber: 0, type: 'insert' };
export const deleteChange: IChange = { isDelete: true, lineNumber: 0, oldLineNumber: 0, type: 'delete' };
